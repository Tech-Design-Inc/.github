...
- 定常業務
  ...
  - UX設計（リサーチ・分析・企画）
- ユーザビリティ向上に向けた施策, 企画
  - ユーザー要望やログ等の情報を定性と定量の両方から把握してプロダクトデザインに反映
...
CEO
- UI/UXについて事業展望から必要な機能・ユーザー体験をヒアリングします。

セールス
- お客さまのニーズ（背景含め）、実務での利用方法をヒアリングします。
  - 「こんなUIだとお客さん使って貰えそうですか？」のようなディスカッションをします。

CS
- お客様の利用状況を踏まえ、どういう運用によってどこが刺さっていてどこが刺さっていないのかをヒアリングします。

エンジニア、PdM
 - 機能仕様やデータ構造をヒアリングし、プロダクトとしてどうあるべきなのかを積極的に議論していきます。
 - 技術的にこういうUI/UXは可能なのか等相談します。

### 技術的チャレンジ

- Horizontal SaaSとして業界横断でPMFする画面情報設計と直感的なUXを実現するDesignの作成
- グローバルに利用してもらうための画面デザインやデザインシステム作り
- 組織のスケールに対して事業速度を鈍化させないための組織や仕組み作り

上記のようなチャレンジを例に、これからの事業成長・展開とともに技術チャレンジが多々あります！

Resilireは競合が少なくまだまだPMFするユーザー体験は模索中です。ステークホルダーが多様なプロダクトをどう情報設計して画面で扱っていくかが弊社のチャレンジであり特徴です。
